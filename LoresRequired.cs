...
public class LoresRequired
{
    ...
    public static void LoadLore()
    {
        Dragon = Lores.RegisterNewLore("Dragon Lore",
            "You have studied the mighty dragons, learning of their habitats, their behaviors, their abilities and the best ways to defeat them.", (_, target) => target.HasTrait(Trait.Dragon));
